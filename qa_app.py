...
def main():
    ...
    <div style="display: flex; align-items: center; margin-left: 0;">
        <h1 style="display: inline-block;">ChatBot</h1>
    </div>
    """,
    unsafe_allow_html=True,
        )
    ...
    embedding_option = "HuggingFace Embeddings(slower)"

    #embedding_option = st.sidebar.radio(
     #   "Choose Embeddings", ["OpenAI Embeddings", "HuggingFace Embeddings(slower)"])

    
    retriever_type = st.sidebar.selectbox( "Choose Retriever", ["SIMILARITY SEARCH", "SUPPORT VECTOR MACHINES"])
